    ...
    def _init_ui(self):
        ...
        dark_input_style = f"""
            ...
            QLineEdit:focus, QDateEdit:focus, QComboBox:focus {{
                border: 1.2px solid {self.dark_theme['accent_blue']};
        ...
        self.items_table.setHorizontalHeaderLabels(["S.No", "Items", "Amount", "Delete"])
        ...
        # Share Button (Dark Theme - Dark Grey)
