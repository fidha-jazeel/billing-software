...
class DashboardFull(QMainWindow):
    ...
    def _create_home_page(self) -> QWidget:
        ...
        # Table (now with a Delete column at the end)
        self.table = QTableWidget(0, 9)
        self.table.setHorizontalHeaderLabels([
            "Item Name", "Ticket #", "Sector", "Supplier", "Price", "Qty", "Tax (%)", "Amount (₹)", "Delete"
        ])
    ...
    def add_item_row(self):
        ...
        delete_btn.setStyleSheet("""
            QPushButton { background-color: #c0392b; color: white; border-radius: 4px; padding: 4px 8px; }
